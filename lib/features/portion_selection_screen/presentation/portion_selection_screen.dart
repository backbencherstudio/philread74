        ...
        child: Column(
          ...
          children: [
            GestureDetector(
              ...
              child: SvgPicture.asset(AppIcons.backButton, height: 28.h, width: 28.w,)),
            ),
            ...
            Consumer(
              builder: (context, ref,_) {
                ...
                return Custombuttons(title: "Next", onTap: () {
               ...
               final updatedValue = ref.read(valueProvider); // read after update
  debugPrint("\n\n$updatedValue\n\n");

                 // context.go(RouteName.portionSelectionScreen);
                });
              }
            ),
          ],
