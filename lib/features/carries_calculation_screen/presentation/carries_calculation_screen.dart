                  ...
                  Row(
                    children: [
                      ...
                      Container(
                        ...
                        child: Text("${ref.read(totalSpace.notifier).state.toStringAsFixed(2)} m²", style: style.bodyMedium!.copyWith(color: AppColors.containerTextColor, fontWeight: FontWeight.w400, fontSize: 12.sp),),
                      )
                    ],
                  ),
